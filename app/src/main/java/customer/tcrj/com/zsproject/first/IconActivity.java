...
public class IconActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener {
    ...
    protected void setView() {
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(IconActivity.this);
                } else {
                    Toast.makeText(IconActivity.this,
...
//        getData(1);
    ...
    private void addIcon() {
        ...
        PictureSelector.create(IconActivity.this)
    ...
    private void getDataFromNet(String result) {
        ...
        mMyOkhttp.post()
                ...
                .enqueue(new GsonResponseHandler<bean>() {
                    @Override
                    public void onFailure(int statusCode, String error_msg) {
                        Toast.makeText(IconActivity.this, error_msg, Toast.LENGTH_SHORT).show();
                        hideLoadingDialog();
                    ...
                    public void onSuccess(int statusCode, bean response) {
                        Toast.makeText(IconActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
//                        hideLoadingDialog();
                        if(response.getStat() == 1){
                            getData(1);
                        }
