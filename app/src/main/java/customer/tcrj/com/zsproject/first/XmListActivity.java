...
public class XmListActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener, mlAdapter.OnItemClickListener, mlAdapter.OnItemEditClickListener {
    ...
    private void initview() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(XmListActivity.this));
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.setAdapter(detailAdapter = new mlAdapter(beanList, XmListActivity.this));
    ...
    private void getData(final int num) {
        ...
        mMyOkhttp.post()
                .url(ApiConstants.XM_ML_LIST_API)
...
//                                loadMoreData(response,false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.num:
                ...
                toClass(this,XmUpdateZSActivity.class,bundle,REQUESTCODE);
                break;
            default:
                break;
        }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        toClass(this,XmIconActivity.class,bundle);
...
/*		Intent intent = new Intent();
    ...
    private void sureRemove(MlListInfo.ResultBean contentBean, final int position) {
        ...
        showLoadingDialog("正在删除目录...");

        mMyOkhttp.post()
                .url(ApiConstants.XM_ML_DEL_API)
                ...
                .enqueue(new GsonResponseHandler<bean>() {
                    ...
                    public void onSuccess(int statusCode, bean response) {
                        Toast.makeText(XmListActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
                        hideLoadingDialog();
                        if(response.getStat() == 1){
