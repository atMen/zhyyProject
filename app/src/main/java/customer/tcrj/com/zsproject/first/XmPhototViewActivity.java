...
public class XmPhototViewActivity extends AppCompatActivity implements View.OnClickListener {
...
//                R.drawable.banner1, R.drawable.btn_dialog, R.drawable.banner1};
        ...
        public View instantiateItem(ViewGroup container, int position) {
            View view = View.inflate(XmPhototViewActivity.this, R.layout.item_base,null);
...
//            photoView.setImageResource(sDrawables[position]);
    ...
    private void sureRemove() {
        ...
        mMyOkhttp.post()
                .url(ApiConstants.XM_ICON_DELE_API)
                ...
                .enqueue(new GsonResponseHandler<bean>() {
                    ...
                    public void onSuccess(int statusCode, bean response) {
                        Toast.makeText(XmPhototViewActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
                        hideLoadingDialog();
