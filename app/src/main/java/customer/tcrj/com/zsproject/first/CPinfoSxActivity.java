...
public class CPinfoSxActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener {
    ...
    @BindView(R.id.subordinate_project)
    Spinner subordinate_project;
    ...
    protected int setLayout() {
        return R.layout.activity_sx_cpinfo;
    }
    ...
    private void getTypeData() {
        ...
        mMyOkhttp.post()
                .url(ApiConstants.DW_JC_TYPE_API)
    ...
    private void initview() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(CPinfoSxActivity.this));
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.setAdapter(detailAdapter = new spjgAdapter(beanList, CPinfoSxActivity.this));
//      detailAdapter.setPreLoadNumber(1);
    ...
    private void getData(final int num,String s) {
        ...
        try {
            ...
            if(DayType > 0){
                jsonObject.put("BasisClass", DayType);
            }

            if(!"".equals(s)){
                jsonObject.put("BasisCode", s);
            }
...
//                            loadMoreData(response,false);
    ...
    //下拉刷新
    private void loadData(proListInfo.ResultBean response,boolean isError) {
