...
public class XmUpdateZSActivity extends Activity implements View.OnClickListener {
...
//                }
    ...
    private void addData(String three) {
        ...
        mMyOkhttp.post()
                .url(bean != null? ApiConstants.XM_ML_EDIT_API : ApiConstants.XM_ML_ADD_API)
                ...
                .enqueue(new GsonResponseHandler<bean>() {
                    ...
                    public void onSuccess(int statusCode, bean response) {
                        hideLoadingDialog();
                        Toast.makeText(XmUpdateZSActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
